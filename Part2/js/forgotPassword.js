...
$("step1Form").addEventListener("submit", function (e) {
  ...
  if (!user) {
    showErr("step1GeneralError", "No account found with that email address.");
    return;
  }
...
function loadQuestion(qNum) {
  activeQ = qNum;
  const question = qNum === 1 ? foundUser.securityQuestion1 : foundUser.securityQuestion2;
...
$("step2Form").addEventListener("submit", function (e) {
  ...
  const correct = activeQ === 1 ? foundUser.securityAnswer1 : foundUser.securityAnswer2;
  ...
  setInvalid("securityAnswer", true);
  showErr("answerError", "That answer is incorrect. Try again or switch questions.");
});
